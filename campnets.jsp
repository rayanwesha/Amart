<%-- 
    Document   : campnets
    Created on : 22-Apr-2024, 16:12:21
    Author     : DELL
--%>
...
<body>
  ...
  <div id="content" style="display: none;">
    ...
    <div class="header-section">
      <div>
        <h1>Welcome to Anwesha ray</h1><br><br>
        <h3>Your one-stop shop for <br>all types of components <br><span id="typewriter"></span></h3>
      ...
      <%
        ...
        try {
            ...
            Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "bmart", "bmart123"); 
             ...
             String sql = "SELECT * FROM (SELECT p.*, ROWNUM r FROM Product p WHERE CATEGORY = 'Electronics') WHERE r BETWEEN ? AND ?";
  ...
  <script>
    ...
    const texts = ["ram", "rom", "reusable-mother bord", "battery"];
    let textIndex = 0;
    let charIndex = 0;
