...
<body>
    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li><a href="profileshop.jsp">
                    <i class="uil uil-estate"></i>
                    <span class="link-name">profile</span>
                </a></li>
                <li><a href="viewodersS.jsp">
                    <i class="uil uil-files-landscapes"></i>
                    <span class="link-name">view oders</span>
                </a></li>
                <li><a href="ADDNPR.jsp">
                    <i class="uil uil-chart"></i>
                    <span class="link-name">add prouduct</span>
                </a></li>
                <li><a href="prouductcards.jsp">
                    <i class="uil uil-chart"></i>
                    <span class="link-name">eadit prouduct</span>
                </a></li>
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            <iframe id="iframe"src="wv.html" width="100%" height="600"></iframe>
        </div>
