<%-- 
    Document   : mobile.jsp
    Created on : 20-Mar-2024, 13:23:39
    Author     : DELL
--%>
...
<body>
  ...
  <div id="content" style="display: none;">
    ...
    <div class="header-section">
      <div>
        ...
        <h3>Your one-stop shop for <br>all types of mobile <br><span id="typewriter"></span></h3>
      ...
      <%
        ...
        try {
            ...
            Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "bmart", "bmart123"); 
             ...
             String sql = "SELECT * FROM (SELECT p.*, ROWNUM r FROM Product p WHERE CATEGORY = 'mobile') WHERE r BETWEEN ? AND ?";
  ...
  <script>
    ...
    const texts = ["iphone", "samsung", "redmi", "poco"];
    let textIndex = 0;
    let charIndex = 0;
