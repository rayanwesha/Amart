<%-- 
    Document   : laptop
    Created on : 22-Apr-2024, 16:10:41
    Author     : DELL
--%>
      ...
      <%
        ...
        try {
            ...
            Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "bmart", "bmart123"); 
             ...
             String sql = "SELECT * FROM (SELECT p.*, ROWNUM r FROM Product p WHERE CATEGORY = 'laptop') WHERE r BETWEEN ? AND ?";
