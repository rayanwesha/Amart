  ...
  <div id="content" style="display: none;">
    ...
    <div class="container">
      <% try {
        ...
        PreparedStatement ps = connection.prepareStatement("SELECT * FROM orders1 WHERE uemail = ?");
        ps.setString(1, uid);
      ...
      <div class="card">
        ...
        <div class="card-details">
          ...
          <% } else { %>
            <a href="pay.jsp?oi=<%=  resultSet.getString("ORDERID")  %>"><button class="shop-now-btn">pay</button></a>
             <a href="updatepru.jsp?oi=<%=  resultSet.getString("ORDERID")  %>"><button class="shop-now-btn">edit</button></a>
  ...
  <footer>
    <div class="footer-content">
      <div class="footer-left">
        ...
        <p><strong>Email:</strong> Anwesha ray.email@gmail.com</p>
    ...
    <div class="footer-bottom">
      <p>&copy; 2024 Anwesha ray. All rights reserved.</p>
    </div>
  </footer>
