...
if (request.getMethod().equalsIgnoreCase("post")) {
    ...
    try {
        ...
        if (mobile.length() != 10) {
            ...
            // Check if email already exists with utype 'shop'
            ...
            if (rs.next()) {
                ...
                ps.setString(6, "shop");
                // Placeholder for image, you can modify this to store image path
                 rs = ps.executeQuery();
                   if (rs.next())
                   {
                       out.println("<div style='text-align: center; color: green;'>Registration successful!</div>");
                       out.println("<script>");
...
%>
<div class="container">
   <img src="shop.webp" alt="Left Image" class="left-image">
    <div class="card">
        ...
        <form action="#" method="post">
            ...
            <label for="address">Shop Address</label><br>
            <textarea id="address" name="address" required></textarea><br>
            <input type="submit" value="Register">
        </form>
    </div>
  <img src="sh.webp" alt="Right Image" class="right-image">
</div>
</body>
</html>
